...
| **See official drone zones along your flights** | `dji-embed flightmap --airspace` | Overlays published airspace zones on the flight map — eleven countries covered, see [Flight records](how-to/flight-record.md) |
