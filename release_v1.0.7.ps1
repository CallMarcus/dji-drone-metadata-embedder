# Complete release process for v1.0.7
Write-Host "DJI Metadata Embedder v1.0.7 Release Process" -ForegroundColor Green
...
git commit -m "docs: update fix summary for v1.0.7"
...
Write-Host "`nStep 3: Creating v1.0.7 release..." -ForegroundColor Cyan
.\create_release.ps1
